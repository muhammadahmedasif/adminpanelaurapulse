  ...
  return (
    <>
      ...
      <div className="mt-auto pt-4 border-t border-outline-variant space-y-1">
        ...
        >
          <div className="w-8 h-8 rounded-full bg-[#111516] border border-outline-variant flex items-center justify-center font-bold text-xs text-primary shadow-sm group-hover:border-primary/60 transition-colors">
            A
          </div>
          <div className="overflow-hidden">
            <p className="font-label-md text-on-surface truncate group-hover:text-primary transition-colors">Admin User</p>
            <p className="text-[9px] uppercase tracking-wider text-outline">Administrator</p>
          </div>
        </Link>
      </div>
    </aside>
